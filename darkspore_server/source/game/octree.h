...
namespace Game {
	...
	class OctTree {
		...
		public:
			...
			void Insert(const ObjectPtr& object);
		...
		protected:
			...
			void GetTriggerInteractions(std::vector<std::tuple<ObjectPtr, ObjectPtr>>& collisions, std::vector<ObjectPtr> parentTriggers) const;
